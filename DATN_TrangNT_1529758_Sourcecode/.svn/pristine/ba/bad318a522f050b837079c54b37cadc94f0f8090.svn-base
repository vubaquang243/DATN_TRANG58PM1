...
public class PhanNhomDAO extends AppDAO {
    ...
    private String CLASS_NAME_DAO = "com.seatech.tp.nhomnsd.PhanNhomDAO";
    private String CLASS_NAME_VO = "com.seatech.tp.nhomnsd.PhanNhomVO";
    ...
    public int insertNsd_nhom(PhanNhomVO vo) throws Exception {
        ...
        //Lay id tu seq
        Long id = getSeqNextValue("tp_nsd_nhom_seq", conn);
        strSQL.append("insert into tp_nsd_nhom (id , nsd_id, nhom_id,CREATED_DATE,CREATED_BY");
    ...
    public int deleteNsd(Long id) throws Exception {
        Vector v_param = new Vector();
        StringBuffer strSQL = new StringBuffer();
        strSQL.append(" delete tp_nsd where id = ?");
        int nExc = 0;
        if (id != null) {
            v_param.add(new Parameter(id, true));
    ...
    public int deleteNsd_nhom(Long nsd_id) throws Exception {
        Vector v_param = new Vector();
        StringBuffer strSQL = new StringBuffer();
        strSQL.append(" delete tp_nsd_nhom where nsd_id = ?");
        int nExc = 0;
        if (nsd_id != null) {
    ...
    public int update(PhanNhomVO vo) throws Exception {
        Vector v_param = new Vector();
        StringBuffer strSQL = new StringBuffer();
        strSQL.append("update tp_nsd set ");
        int nExc = 0;
    ...
    public int delete(Long nNsdID, Long nNhomID) throws Exception {
        Vector v_param = new Vector();
        StringBuffer strSQL = new StringBuffer();
        strSQL.append(" delete tp_nsd_nhom where nsd_id = ? and nhom_id = ?");
        int nExc = 0;
        if (nNsdID != null) {
  ...
  public Collection getNSDNhom(String whereClause,
      ...
      StringBuffer strSQL = new StringBuffer();
      try {
          strSQL.append("SELECT a.id, a.nsd_id, a.nhom_id, a.created_date, a.created_by from tp_nsd_nhom a");
