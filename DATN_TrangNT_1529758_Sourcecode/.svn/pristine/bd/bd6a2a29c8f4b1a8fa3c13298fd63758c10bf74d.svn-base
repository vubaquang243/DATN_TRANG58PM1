...
public class QLyLapBangKeVO extends BaseVO {
    ...
    private String tu_ngay_ph;

    private String den_ngay_ph;
    ...
    private Collection lstCTietBKeCTien;

    private String listIdSoHuu;

    private String list_id_so_huu;

    private String ptph_tpcp;
    ...
    public void setTu_ngay_ph(String tu_ngay_ph) {
        this.tu_ngay_ph = tu_ngay_ph;
    }

    public String getTu_ngay_ph() {
        return tu_ngay_ph;
    }

    public void setDen_ngay_ph(String den_ngay_ph) {
        this.den_ngay_ph = den_ngay_ph;
    }

    public String getDen_ngay_ph() {
        return den_ngay_ph;
    }
    ...
    public void setLstCTietBKeCTien(Collection lstCTietBKeCTien) {
        this.lstCTietBKeCTien = lstCTietBKeCTien;
    }

    public Collection getLstCTietBKeCTien() {
        return lstCTietBKeCTien;
    }

    public void setListIdSoHuu(String listIdSoHuu) {
        this.listIdSoHuu = listIdSoHuu;
    }

    public String getListIdSoHuu() {
        return listIdSoHuu;
    }

    public void setPtph_tpcp(String ptph_tpcp) {
        this.ptph_tpcp = ptph_tpcp;
    }

    public String getPtph_tpcp() {
        return ptph_tpcp;
    }
    ...
    public void setList_id_so_huu(String list_id_so_huu) {
        this.list_id_so_huu = list_id_so_huu;
    }

    public String getList_id_so_huu() {
        return list_id_so_huu;
    }
