...
<script type="text/javascript">
  ...
  function validateForm() {
      ...
      if (ngay_thanh_toan_tu_ngay == null && ngay_thanh_toan_tu_ngay == '') {
          alert('Vui lòng nhập Ngày đến hạn thanh toán từ ngày !');
          $("#ngay_thanh_toan_tu_ngay").focus();
          return false;
      }
      if (ngay_thanh_toan_den_ngay == null && ngay_thanh_toan_den_ngay == '') {
          alert('Vui lòng nhập Ngày đến hạn thanh toán đến ngày !');
      ...
      if ((ngay_thanh_toan_tu_ngay != null && ngay_thanh_toan_tu_ngay != "") && (ngay_thanh_toan_den_ngay != null && ngay_thanh_toan_den_ngay != "")) {
          ...
          if (startDate > endDate) {
              alert('Ngày đến hạn thanh toán đến ngày phải lớn hơn Ngày đến hạn thanh toán từ ngày !');
              $("#ngay_thanh_toan_tu_ngay").focus();
              return false;
          }
      }
  ...
  function view(id_lenh) {
      var f = document.forms[0];
      f.action = 'ViewLenhTraNoAction.do?longid='+id_lenh;
      f.submit();
  }
  $(function () {
      $("#so_lenh").focus();
...
<html:form action="/ListLenhTraNoAction.do" method="post">
  <div class="panel-heading border-bottom">
    <h1 class="panel-title">
      <strong>Quản lý thông tin lệnh chi trả nợ trong nước bằng VNĐ</strong>
    </h1>
  </div>
  <div class="app_error">
        ...
        %>
          <logic:iterate id="objTPCP" name="listLenhTriTraNo" indexId="stt">
            <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>' ondblclick="view('<bean:write name="objTPCP" property="guid"/>')">
              ...
              <td align="center">
                <bean:write name="objTPCP" property="ngay_chuyen"/>
              </td>
              <td align="right">
              ...
              <td align="left">
                <bean:write name="objTPCP" property="ten_trang_thai"/>
                  ...
                  <input type="hidden" id="guide" value="<bean:write name="objTPCP" property="guid"/>" />
              <td class="icon">                     
                 <logic:notEqual value="01" name="objTPCP" property="trang_thai">
                    <logic:notEqual value="02" name="objTPCP" property="trang_thai">
                      <a href='<html:rewrite page="/ViewLenhTraNoAction.do"/>?longid=<bean:write name="objTPCP" property="guid"/>'>
              ...
              <td class="icon">
                <logic:notEqual value="01" name="objTPCP" property="trang_thai">
                    <logic:notEqual value="02" name="objTPCP" property="trang_thai">
                     <a href='<html:rewrite page="/DeleteLenhTraNoAction.do"/>?longid=<bean:write name="objTPCP" property="guid"/>&loaitt=<bean:write name="objTPCP" property="loai_thanh_toan"/>&solenh=<bean:write name="objTPCP" property="so_lenh"/>'
                     onclick="return confirm('Bạn có chắc chắn muốn xóa LCTN này?')" >
