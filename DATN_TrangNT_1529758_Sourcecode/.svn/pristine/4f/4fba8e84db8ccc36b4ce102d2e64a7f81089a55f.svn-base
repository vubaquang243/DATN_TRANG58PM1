...
<script type="text/javascript">
  ...
  function check(type) {
   ...
   function view(id) {
      ...
      f.target = '';
      if(id != null && id != ""){
      f.action = 'QuanLyKeHoachPDViewAction.do?longid=' + id;
      f.submit();
      }
  }
...
<html:form action="/SearchQuanLyKeHoachPDAction.do" method="post">
             ...
             <bean:write name="objTPCP" property="nam_ph"/>
              ...
              <td class="icon">
                <logic:equal value="01" name="objTPCP" property="trang_thai">
                  <a href='<html:rewrite page="/QuanLyKeHoachPDViewAction.do"/>?longid=<bean:write name="objTPCP" property="guid"/>'>
