package com.seatech.tp.thamchieu;
...
public class MaThamChieuDAO extends AppDAO {
    ...
    private static String CLASS_NAME_DAO =
        "com.seatech.tp.thamchieu.MaThamChieuDAO";
    private static String CLASS_NAME_VO =
        "com.seatech.tp.thamchieu.MaThamChieuVO";
  ...
  public Collection getMaThamChieuLTTDenList(String whereClause,
      ...
      try {
          ...
          strSQL.append("a.rv_abbreviation, a.rv_meaning from tp_DM_MA_THAMCHIEU a");
