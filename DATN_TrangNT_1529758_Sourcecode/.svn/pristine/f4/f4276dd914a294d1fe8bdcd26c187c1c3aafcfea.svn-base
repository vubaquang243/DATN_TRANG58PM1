...
function view(id) {
      ...
      f.target = '';
      if(id != null && id != ""){
      f.action = 'viewBanLeTraiPhieuTwAction.do?longid=' + id;
      f.submit();
      }
  }
...
<html:form action="/SearchBanLeTraiPhieuTwAction.do" method="post">
                ...
                <div class="col-sm-8">
                  <div class="input-group date">
                    <html:text styleClass="form-control"
                               ...
                               styleId="ngay_phat_hanh_tu_ngay" maxlength="10"
                ...
                <div class="col-sm-8">
                  <div class="input-group date">
                    <html:text styleClass="form-control"
                               ...
                               styleId="ngay_phat_hanh_den_ngay" maxlength="10"
  ...
  <div class="panel panel-default">
    ...
    <table class="table table-bordered">
      <thead>
        ...
        <th class="center">
          <fmt:message key="BanLeTraiPhieuTw.sua"/>
        </th>
        <th class="center">
          <fmt:message key="BanLeTraiPhieuTw.xoa"/>
        </th>
      </thead>
      ...
      <tbody>
        ...
        <logic:notEmpty name="lstBanLeTraiPhieuTw">
          <logic:iterate id="objBanLeTraiPhieuTw" name="lstBanLeTraiPhieuTw"
                         >
            <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>' ondblclick="view('<bean:write name="objBanLeTraiPhieuTw" property="guid"/>')">
              <td class="center">
                <%=stt+=1%>
              </td>
              <td class="left">
              ...
              <td class="icon">
                <logic:notEqual value="1" name="objBanLeTraiPhieuTw"
                                property="trang_thai">
                  <logic:notEqual value="2" name="objBanLeTraiPhieuTw"
                                  property="trang_thai">
                    <a href='<html:rewrite page="/UpdateBanLeTraiPhieuTwAction.do"/>?longid=<bean:write name="objBanLeTraiPhieuTw" property="guid"/>'>
              ...
              <td class="icon">
                <logic:notEqual value="1" name="objBanLeTraiPhieuTw"
                  ...
                  <logic:notEqual value="2" name="objBanLeTraiPhieuTw"
                                  property="trang_thai">
                    <a href='<html:rewrite page="/DeleteBanLeTraiPhieuTwAction.do"/>?longid=<bean:write name="objBanLeTraiPhieuTw" property="guid"/>'
