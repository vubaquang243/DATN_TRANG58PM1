...
<script type="text/javascript">
 ...
 function viewCTiet(guid) {
      var f = document.forms[0];
      f.target = '';
      if (guid != null && guid != '') {
          f.action = 'ViewPDuyetBangKeAction.do?longid=' + guid;
          f.submit();
      }
  }
  $(function () {
...
<html:form action="/SearchPDuyetBangKeAction.do" method="post">
  <div class="panel-heading border-bottom">
    <h1 class="panel-title">
      <strong>PHÊ DUYỆT BẢNG KÊ XÁC NHẬN CHUYỂN TIỀN</strong>
    </h1>
  </div>
  <div class="app_error">
  ...
  <div class="panel panel-default">
    ...
    <table class="table table-bordered">
      <thead>
        ...
        <th class="center">
          <fmt:message key="tpbkechuyentien.ls_danh_nghia"/> <br> (%/năm)
        </th>
        <th class="center">
          <fmt:message key="tpbkechuyentien.trang_thai"/>
        </th>
      ...
      <tbody>
        ...
        <logic:notEmpty name="lstBKeXNhan">
          <logic:iterate id="objBKe" name="lstBKeXNhan" indexId="stt">
            <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>' ondblclick="viewCTiet('<bean:write name="objBKe" property="guid"/>');">
              <td align="center">
                <%=rowBegin + stt + 1%>
              </td>
              <td>
              ...
              <td class="icon">
                <logic:equal value="01" name="objBKe" property="trang_thai">
                <a href='<html:rewrite page="/ViewPDuyetBangKeAction.do"/>?longid=<bean:write name="objBKe" property="guid"/>'>
