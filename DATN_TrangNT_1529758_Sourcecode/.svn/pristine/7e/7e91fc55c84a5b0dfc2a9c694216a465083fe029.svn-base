...
<html:form action="/SearchTTPhiHNXAction.do" method="post">
  <div class="panel-heading border-bottom">
    <h1 class="panel-title">
      <strong>Thanh toán phí đấu thầu phát hành trái phiếu qua HNX (VNĐ)</strong>
    </h1>
  </div>
  <div class="app_error">
        ...
        <logic:empty name="listLenhTraNo">
          <tr>
            <td colspan="16" align="center" style="color:red">
               Không có Mã trái phiếu cần thanh toán phí đấu thầu
            </td>
          </tr>
        </logic:empty>
        </logic:notEmpty>
