  ...
  function check(type) {
      ...
      if (type == 'pheduyet') {
          if (confirm('Bạn có muốn phê duyệt kế hoạch quý này không ?')) {
              f.action = 'PheDuyetKHQuyAction.do';
              f.submit();
          }
      }
      if (type == 'tuchoi') {
          ...
          f.action = 'TuChoiKHQuyAction.do';
          f.submit();
      }
      if(type== 'close'){
        f.action='ListQuanLyKeHoachQuyPDAction.do';
        f.submit();
      }
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-8">
               <html:select property="thoi_gian_ph" styleId="thoi_gian_ph"  name="QuanLyKeHoachQuyForm"  disabled="true"
          ...
          <div class="col-md-6" id="div_lydotuchoi">
            <div class="form-group">
              ...
              <logic:equal value="01" name="QuanLyKeHoachQuyForm" property="trang_thai">
                ...
                <logic:notEqual value="01" name="QuanLyKeHoachQuyForm" property="trang_thai">
                <html:textarea rows="2" styleClass="form-control"
                                 style="margin: 0px; width: 770px; height: 50px;"
                               styleId="ly_do_tu_choi"
