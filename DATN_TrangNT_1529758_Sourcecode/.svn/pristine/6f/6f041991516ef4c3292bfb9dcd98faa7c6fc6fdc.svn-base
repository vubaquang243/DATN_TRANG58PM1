...
public class DMKBacDAO extends AppDAO {
    private String CLASS_NAME_VO = "com.seatech.tp.dmkb.DMKBacVO";
    private String CLASS_NAME_DAO = "com.seatech.tp.dmkb.DMKBacDAO";
    ...
    public Collection getDMKBList(String whereClause,
        ...
        try {
            ...
            strSQL.append("from tp_dm_htkb a ");
    ...
    public Collection getDMKBTCUUList(String whereClause,
        ...
        try {
            ...
            strSQL.append("FROM  tp_dm_htkb a, tp_tknh_kb b, tp_dm_htkb c");
            if (whereClause != null && !STRING_EMPTY.equals(whereClause)) {
    ...
    public Collection getDMNHKBList(String whereClause,
        ...
        try {
            ...
            strSQL.append("a.ma_t, a.ma_h, a.cap ");
            strSQL.append("from tp_dm_htkb a left join tp_dm_manh_shkb b on a.ma=b.shkb ");
            if (whereClause != null && !STRING_EMPTY.equals(whereClause)) {
                strSQL.append(" WHERE " + whereClause);
            }
    ...
    public DMKBacVO getDMKB(String whereClause,
        ...
        try {
            ...
            strSQL.append("SELECT a.ma, b.ma_nh,  a.ten, a.tinhtrang, a.id, a.ma_cha, a.id_cha, a.loai, ");
            strSQL.append("a.ma_t, a.ma_h, a.cap ");
            strSQL.append("from tp_dm_htkb a, tp_dm_manh_shkb b WHERE a.ma= b.shkb(+) " +
                          whereClause);
            strSQL.append(" order by  a.ten");
            DMKBacVO dmkbVO =
    ...
    public String getMaKB8So(String strMaKB) throws DAOException {
        ...
        try {
            ...
            strSQL.append("SELECT a.ma_nh, a.shkb, a.ten from tp_dm_manh_shkb a ");
...
//        String strMaDVSDNS = "";
        ...
        try {
            String strSQL =
                "select ma_dvsdns from tp_dm_shkb_dvsdns where ma_kb = ? and loai_gd = ?";
            Vector vParam = new Vector();
            vParam.add(new Parameter(strMaKB, true));
    ...
    public int update(DMKBacVO vo) throws Exception {
        ...
        int nExc = 0;
        try {
            strSQL.append("update tp_dm_htkb set ");
    ...
    public int insert(DMKBacVO vo) throws Exception {
        ...
        strSQL.append("insert into tp_dm_htkb (id ");
    ...
    public Collection getDMucKBHuyen(String strWhere,
        ...
        try {
            ...
            strSQL +=
                    ...
                    " FROM   tp_dm_htkb a, tp_tknh_kb b, tp_dm_htkb c, tp_dm_manh_shkb d, tp_dm_ngan_hang e " +
    ...
    public Collection getDMucKB_cha(String strWhere,
        ...
        try {
            ...
            strSQL +=
                    " SELECT   DISTINCT  a.id_cha, c.ten, c.ma FROM   tp_dm_htkb a, tp_tknh_kb b, tp_dm_htkb c, tp_dm_ngan_hang d" +
