        ...
        <tr>
          ...
          <td background="<%=request.getContextPath()%>/styles/images/T2.jpg"
            ...
            <span class="title2" height="24"
                  ...
                  colspan="6">
              <font size="2">
                <fmt:message key="quanlynsd.listnsd.title"/>
              </font></span>
          </td>
          <td width="62">
        ...
        <tr>
          <td>
            <table width="80%" cellspacing="0" cellpadding="1"
              ...
              <tr>
                <td width="15%" align="right" bordercolor="#e1e1e1">ten thread</td>
                ...
                <td width="15%" align="right" bordercolor="#e1e1e1">time_start</td>
                <td width="29%" align="left" bordercolor="#e1e1e1">
                ...
                <td width="15%" align="right" bordercolor="#e1e1e1">time_stop</td>
                <td width="29%" align="left" bordercolor="#e1e1e1">
                ...
                <td width="15%" align="right" bordercolor="#e1e1e1">time_sleeping</td>
                <td width="29%" align="left" bordercolor="#e1e1e1">
                ...
                <td width="15%" align="right" bordercolor="#e1e1e1">mo_ta</td>
                <td width="29%" align="left" bordercolor="#e1e1e1">
                ...
                <td width="15%" align="right" bordercolor="#e1e1e1">ngay_cap_nhat</td>
                <td width="29%" align="left" bordercolor="#e1e1e1">
                ...
                <td width="15%" align="right" bordercolor="#e1e1e1">user_id</td>
                <td width="29%" align="left" bordercolor="#e1e1e1">
                ...
                <td width="15%" align="right" bordercolor="#e1e1e1">class_name</td>
                <td width="29%" align="left" bordercolor="#e1e1e1">
              ...
              <tr>
                <td width="15%" align="right" bordercolor="#e1e1e1">log_info</td>
                <td width="29%" align="left" bordercolor="#e1e1e1">
                ...
                <td width="15%" align="right" bordercolor="#e1e1e1">log_error</td>
                <td width="29%" align="left" bordercolor="#e1e1e1">
