...
public class ChucNangDAO extends AppDAO {
    ...
    private static String CLASS_NAME_DAO =
        "com.seatech.tp.chucnang.ChucNangDAO";
    private static String CLASS_NAME_VO =
        "com.seatech.tp.chucnang.ChucNangVO";
    ...
    public Collection getChucNangList(String whereClause,
        ...
        try {
            ...
            strSQL.append("from tp_chucnang a");
    ...
    public Collection getChucNangListByUserID(Long nUserID) throws Exception {
        ...
        try {
            ...
            strSQL.append("a.hien_thi, a.sap_xep, a.trang_thai, a.ma_cnang, a.loai_cnang, a.ky_hieu_cnang ");
            strSQL.append("from tp_chucnang a ");
            strSQL.append("inner join tp_cnang_nhom b on a.id = b.cnang_id ");
            strSQL.append("inner join tp_nhom_nsd c on b.nhom_id = c.id ");
            strSQL.append("inner join tp_nsd_nhom d on d.nhom_id = c.id ");
            strSQL.append("inner join tp_nsd e on e.id = d.nsd_id ");
