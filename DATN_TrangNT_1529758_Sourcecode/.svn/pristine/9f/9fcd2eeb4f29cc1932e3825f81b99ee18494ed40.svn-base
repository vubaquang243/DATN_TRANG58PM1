package com.seatech.tp.qlytinphieu.form;
...
public class HDBanTinPhieuForm extends ActionForm {
    private String guid;
    ...
    public void setKl_tp(String kl_tp) {
        this.kl_tp = kl_tp;
    }
    ...
    public void setTt_dky_lky(String tt_dky_lky) {
        this.tt_dky_lky = tt_dky_lky;
    }
