...
public class QLyLenhTraNoPDAction extends AppAction {
    private static String SUCCESS = "success";
    private static String FAILURE = "failure";

    public QLyLenhTraNoPDAction() {
        super();
    }
    ...
    public ActionForward search(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            listLenhTriTraNo =
                    delegate.getListLenhTraNoPDPaging(vo, currentPage, numberRowOnPage,
                                               totalCount);
