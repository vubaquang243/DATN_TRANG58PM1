...
public class QLyKQPhatHanhDAO extends AppDAO {
    ...
    public QLyKQPhatHanhCTiet_TpcpVO getKQPH_CTIET_TPCP(String dot_dt) throws Exception, TPCPException {
        ...
        try {
            strSQL.append("SELECT \n" +
                    " T.GUID,to_char(decode(T.LS_DANH_NGHIA,'0','',T.LS_DANH_NGHIA) , 'fm9999.00') LS_DANH_NGHIA " + " FROM TPCP_OWNER.TP_KQPH_CTIET_TPCP T inner join TP_KQPH b on T.TP_KQ_PH_ID=b.GUID  ");
