...
public class QuanLyTPCPVO extends BaseVO {

    private String ma_tp;

    private String phuong_thuc_ph;

    private String ten_phuong_thuc_ph;
    ...
    public void setTen_phuong_thuc_ph(String ten_phuong_thuc_ph) {
        this.ten_phuong_thuc_ph = ten_phuong_thuc_ph;
    }

    public String getTen_phuong_thuc_ph() {
        return ten_phuong_thuc_ph;
    }
