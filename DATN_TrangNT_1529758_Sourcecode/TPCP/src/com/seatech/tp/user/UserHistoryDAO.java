...
public class UserHistoryDAO extends AppDAO {
    ...
    private String CLASS_NAME_VO = "com.seatech.tp.user.UserHistoryVO";
    private String CLASS_NAME_DAO = "com.seatech.tp.user.UserHistoryDAO";
    ...
    public int insert(UserHistoryVO vo) throws Exception {
        ...
        //Lay seq
        Long lID = getSeqNextValue("tp_nsd_lsu_seq", conn);

        strSQL.append("insert into tp_nsd_lsu (id ");
    ...
    public Collection getLsuUserList(String whereClause, Vector vParam,
        ...
        try {
            ...
            strSQL.append("from tp_nsd_lsu a  , tp_nsd b,  tp_nsd b2");
