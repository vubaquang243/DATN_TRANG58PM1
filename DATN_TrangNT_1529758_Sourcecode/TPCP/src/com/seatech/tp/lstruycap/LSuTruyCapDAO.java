package com.seatech.tp.lstruycap;
...
public class LSuTruyCapDAO extends AppDAO {
    ...
    private String CLASS_NAME_DAO = "com.seatech.tp.lstruycap.LSuTruyCapDAO";
    private String CLASS_NAME_VO = "com.seatech.tp.lstruycap.LSuTruyCapVO";
    ...
    public Collection getLSuTruyCapList(String whereClause,
        ...
        try {
            ...
            strSQL.append("from tp_lsu_truycap a");
...
//            daoEx.printStackTrace();
    ...
    public Collection getLSuTruyCapList(String strWhere, Vector vParam,
        ...
        try {
            ...
            strSQL.append(" from tp_lsu_truycap a");
            strSQL.append(" INNER JOIN tp_nsd b ");
            strSQL.append(" ON a.nsd_id = b.id");
            strSQL.append(" INNER JOIN tp_chucnang c");
...
//            daoEx.printStackTrace();
    ...
    public int insert(LSuTruyCapVO vo) throws Exception {
        ...
        try {
            Long nID = getSeqNextValue("TP_LSU_TRUYCAP_SEQ", conn);

            strSQL.append("insert into tp_LSU_TRUYCAP (id ");
