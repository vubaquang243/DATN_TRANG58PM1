package com.seatech.tp.nhomnsd;
...
public class NhomNSDDAO extends AppDAO {
    ...
    private String CLASS_NAME_DAO = "com.seatech.tp.nhomnsd.NhomNSDDAO";
    private String CLASS_NAME_VO = "com.seatech.tp.nhomnsd.NhomNSDVO";
    ...
    public Collection getNhomNSDList(String whereClause,
        ...
        try {
            strSQL.append("SELECT a.id, a.ten_nhom, a.loai_nhom  from tp_nhom_nsd a");
  ...
  public Collection getNhomNSDListM(String whereClause,
                                   Vector params) throws Exception {
      Collection reval = null;
      StringBuffer strSQL = new StringBuffer();
      try {
          strSQL.append("SELECT DISTINCT   a.loai_nhom  from tp_nhom_nsd a");
...
//          }
  ...
  public ResultSet getNhomNSDList(String whereClause) throws Exception {
    ...
    public Collection getNhomNSDListByUserID(Long nUserID) throws Exception {
        StringBuffer strSQL = new StringBuffer();
        try {
            strSQL.append("SELECT a.id, a.ten_nhom, a.loai_nhom  from tp_nhom_nsd a inner join tp_nsd_nhom b ");
    ...
    public Long insert(NhomNSDVO vo) throws Exception {
        ...
        //L?y ID t? seq
        Long lID = getSeqNextValue("tp_nhom_nsd_seq", conn);
        strSQL.append("insert into tp_nhom_nsd (id ");
    ...
    public int update(NhomNSDVO vo) throws Exception {
        Vector v_param = new Vector();
        StringBuffer strSQL = new StringBuffer();
        strSQL.append("update tp_nhom_nsd set ");
        int nExc = 0;
        if (vo.getTen_nhom() != null) {
            strSQL.append(" ten_nhom = ? ");
            v_param.add(new Parameter(vo.getTen_nhom(), true));
    ...
    public int delete(Long id) throws Exception {
        Vector v_param = new Vector();
        StringBuffer strSQL = new StringBuffer();
        strSQL.append(" delete tp_nhom_nsd where id = ?");
        int nExc = 0;
        if (id != null) {
    ...
    public NhomNSDVO getNSDNhom(String whereClause,
        ...
        try {
            ...
            strSQL.append("from tp_nsd_nhom a");
            if (whereClause != null && !STRING_EMPTY.equals(whereClause)) {
                strSQL.append(" WHERE " + whereClause);
            }
            return (NhomNSDVO)findByPK(strSQL.toString(), params,
  ...
  public int deleteNsd_nhom(String strwhere, Vector v_param) throws Exception {
    try {
      ...
      int nExc = 0;
      StringBuffer strSQL = new StringBuffer();
      strSQL.append(" delete tp_nsd_nhom ");
      if(strwhere != null)
      {
