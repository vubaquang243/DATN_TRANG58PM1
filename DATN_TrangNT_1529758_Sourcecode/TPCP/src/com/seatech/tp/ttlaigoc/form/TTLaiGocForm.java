package com.seatech.tp.ttlaigoc.form;
...
public class TTLaiGocForm extends ActionForm {
    private String guid;
    ...
    private Collection list_Lenh_tra_no_chi_tiet;
	
	private String ngay_to_chuc_ph_tu_ngay;

    private String ngay_to_chuc_ph_den_ngay;

    private String ngay_ph_tu_ngay;

    private String ngay_ph_den_ngay;
    ...
    public TTLaiGocForm() {
        ...
        this.ty_gia = "";
        this.list_Lenh_tra_no_chi_tiet = new ArrayList();
    }
    ...
    public void setList_Lenh_tra_no_chi_tiet(Collection list_Lenh_tra_no_chi_tiet) {
        this.list_Lenh_tra_no_chi_tiet = list_Lenh_tra_no_chi_tiet;
    }

    public Collection getList_Lenh_tra_no_chi_tiet() {
        return list_Lenh_tra_no_chi_tiet;
    }

    public void setNgay_ph_tu_ngay(String ngay_ph_tu_ngay) {
        this.ngay_ph_tu_ngay = ngay_ph_tu_ngay;
    }

    public String getNgay_ph_tu_ngay() {
        return ngay_ph_tu_ngay;
    }

    public void setNgay_ph_den_ngay(String ngay_ph_den_ngay) {
        this.ngay_ph_den_ngay = ngay_ph_den_ngay;
    }

    public String getNgay_ph_den_ngay() {
        return ngay_ph_den_ngay;
    }
