...
public class TTLaiGocUsdAction extends AppAction {
    ...
    public ActionForward search(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            if(vo.getMa_tpcp()==null) vo.setMa_tpcp("");
            if(vo.getPhuong_thuc_ph()==null) vo.setPhuong_thuc_ph("");
            if(vo.getLoai_tien()==null) vo.setLoai_tien("VND");
            if(vo.getTy_gia()==null) vo.setTy_gia("0");
