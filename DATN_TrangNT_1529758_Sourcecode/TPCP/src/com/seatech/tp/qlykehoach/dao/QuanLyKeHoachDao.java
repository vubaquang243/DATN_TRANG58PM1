package com.seatech.tp.qlykehoach.dao;
...
public class QuanLyKeHoachDao extends AppDAO {
  private Connection conn = null;
  private String CLASS_NAME_DAO =
      "com.seatech.tp.qlykehoach.dao.QuanLyKeHoachDao";
  private String CLASS_NAME_VO =
      "com.seatech.tp.qlykehoach.vo.QuanLyKeHoachVo";
  private String CLASS_KHPH_VO =
      "com.seatech.tp.qlykehoach.vo.KHPHChiTietNamVO";
  private static String STRING_EMPTY = "";

  public QuanLyKeHoachDao(Connection conn) {
      super();
      this.conn = conn;
  }

  public Long insert(QuanLyKeHoachVo vo) throws Exception {
  ...
  public Long insertKHCT(KHPHChiTietNamVO vo) throws Exception {
      Vector v_param = new Vector();
      //L?y ID t? seq
      Long lID = new Long("0");
  ...
  public Collection getListQLKHPaging(QuanLyKeHoachVo vo, Integer page,
      ...
      try {
          ...
          if (vo.getThoi_gian_ph() != null &&
           ...
           whereClause+=" and loai_kh='Yr' ";
          if (vo.getNam_ph() != null && !"".equals(vo.getNam_ph())) {
              whereClause += " and  a.NAM_PH  like '%"+vo.getNam_ph()+"%' ";
  ...
  public Collection getListQLKHPagingCheck(QuanLyKeHoachVo vo, Integer page,
                                    ...
                                    Integer[] totalCount) throws Exception {
    Collection reval = null;
    String whereClause = " and loai_kh ='Yr' ";
    Vector vParam = new Vector();
    StringBuffer strSQL = new StringBuffer();
    try {
  ...
  public Collection getListPD(QuanLyKeHoachVo vo, Integer page,
                              ...
                              Integer[] totalCount) throws Exception {
      Collection reval = null;
      String whereClause = "and a.TRANG_THAI != '00' and a.loai_kh='Yr' ";
      Vector vParam = new Vector();
      StringBuffer strSQL = new StringBuffer();
      try {
          strSQL.append(" SELECT a.GUID,a.THOI_GIAN_PH,a.NAM_PH, a.LOAI_KH,a.TONG_KLPH,a.LOAI_TIEN ,SO_TBAO_KH_CU ," +
  ...
  public QuanLyKeHoachVo getQLKHObject(Map<String, Object> map) throws Exception,
      ...
      try {
        ...
        strSQL2.append(" and loai_kh='Yr' ");
          if (strSQL2.toString().length() > 0) {
              strSQL.append(" WHERE 1 = 1 " + strSQL2.toString());
          }
          return (QuanLyKeHoachVo)findByPK(strSQL.toString(), vParam,
                                              CLASS_NAME_VO, conn);
      } catch (Exception ex) {
  ...
  public QuanLyKeHoachVo getTpKeHoachCheckObject(String sNamph, String sThoigianph) throws Exception,
    ...
    try {
        strSQL.append("SELECT GUID, NAM_PH,  THOI_GIAN_PH,  TONG_KLPH,  LOAI_TIEN,SO_TBAO_KH_CU ," +
                      ...
                      "  MO_TA,  TRANG_THAI,  NGUOI_TAO, to_char(NGAY_TAO,'dd/MM/yyyy') NGAY_TAO,  NGUOI_SUA_CUOI,to_char(NGAY_SUA_CUOI,'dd/MM/yyyy')  NGAY_SUA_CUOI, " +
                      "  NGUOI_DUYET, to_char(NGAY_DUYET,'dd/MM/yyyy') NGAY_DUYET,  LY_DO_TU_CHOI" +
                      "  FROM TP_KH_PH WHERE NAM_PH = '" + sNamph + "'" +  " and THOI_GIAN_PH = '" + sThoigianph + "' and loai_kh='Yr' ");
        
        return (QuanLyKeHoachVo)findByPK(strSQL.toString(), null,
                                            CLASS_NAME_VO, conn);
    } catch (Exception ex) {
        throw new DAOException(CLASS_NAME_DAO + ".getQLKHObject(): " +
                               ex.getMessage(), ex);
  ...
  public QuanLyKeHoachVo getQLKHObject(String guid) throws Exception,
                                                              TPCPException {
      StringBuffer strSQL = new StringBuffer();
      try {
          strSQL.append("SELECT GUID, NAM_PH,  LOAI_KH,  THOI_GIAN_PH,  TONG_KLPH,  LOAI_TIEN,SO_TBAO_KH_CU ," +
  ...
  public Long deleteChiTiet(QuanLyKeHoachVo vo) throws Exception {
      Vector v_param = new Vector();
      StringBuffer strSQL = new StringBuffer();
  ...
  public Long delete(QuanLyKeHoachVo vo) throws Exception {
    Vector v_param = new Vector();
    StringBuffer strSQL = new StringBuffer();
