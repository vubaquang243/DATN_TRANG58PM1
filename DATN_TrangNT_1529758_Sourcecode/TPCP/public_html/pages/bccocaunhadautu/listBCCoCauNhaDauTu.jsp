...
<script type="text/javascript">
  ...
  function check(type) {
      ...
      if (type == 'close') {
          ...
          if (validateForm()) {
              f.action = 'SearchBCCoCauNhaDauTuAction.do';
              f.submit();
          }
      }
      else if (type == 'print') {
          if (validateForm()) {
              f.action = 'PrintBCCoCauNhaDauTuAction.do';
...
<html:form action="/ListBCCoCauNhaDauTuAction.do" method="post">
  <div class="panel-heading border-bottom">
    <h1 class="panel-title">
      <strong>
        <fmt:message key="BCCoCauNhaDauTu.title"/></strong>
    </h1>
  </div>
  <div class="app_error">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h2 class="panel-title">
        <fmt:message key="BCCoCauNhaDauTu.list.find"/>
      </h2>
    </div>
  ...
  <div class="panel panel-default">
    <!--<div class="panel-heading">
      <h2 class="panel-title">
        <fmt:message key="BCCoCauNhaDauTu.list.result"/>
      </h2>
    </div>-->
    <%-- Hiển thị list--%>
    <!--<table class="table table-bordered">
      <thead>
        <tr class="header">
          <th class="center" >
            <fmt:message key="BCCoCauNhaDauTu.chi_tieu"/>
          </th>
          <th class="center">
            <fmt:message key="BCCoCauNhaDauTu.khoi_luong"/>
          </th>
          <th class="center">
            <fmt:message key="BCCoCauNhaDauTu.ty_trong"/>
          </th>
      </thead>
       
      <tbody>
        <logic:empty name="lstBCCoCauNhaDauTu">
          <tr>
            <td colspan="3" align="center" class="color_red">
              <fmt:message key="BCCoCauNhaDauTu.list.norecord"/>
            </td>
          </tr>
        </logic:empty>
        <logic:notEmpty name="lstBCCoCauNhaDauTu">
          <%
            com.seatech.framework.common.jsp.PagingBean pagingBean = (com.seatech.framework.common.jsp.PagingBean)request.getAttribute("PAGE_KEY");
            int rowBegin = (pagingBean.getCurrentPage() -1) * 15;
        %>
          <logic:iterate id="objBCCoCauNhaDauTu" name="lstBCCoCauNhaDauTu">
            <td class="right">
              <bean:write name="objBCCoCauNhaDauTu" property="chi_tieu"/>
            </td>
            <td class="right">
              <bean:write name="objBCCoCauNhaDauTu" property="khoi_luong"/>
            </td>
            <td class="right">
              <bean:write name="objBCCoCauNhaDauTu" property="ty_trong"/>
            </td>
          </logic:iterate>
          <tr>
