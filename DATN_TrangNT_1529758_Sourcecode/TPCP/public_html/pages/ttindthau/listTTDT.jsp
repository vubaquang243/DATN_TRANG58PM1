...
//  });
  ...
  function view(guid) {
      ...
      f.target = '';
      if (guid != null && guid != '') {
          f.action = 'ViewTTinDThauAction.do?longid=' + guid;
          f.submit();
      }
  }
  ...
  <div class="panel panel-default">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <html:text styleClass="form-control"  styleId="dot_dau_thau"      
                           ...
                           property="dot_dau_thau" maxlength="10"/>
              </div>
            </div>
          </div>
             <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <html:select property="trang_thai" styleId="trang_thai"
                  ...
                  <html:option value="05">Đ&atilde; c&ocirc;ng bố</html:option>
                </html:select>
              </div>
            </div>
          </div>
    ...
    <div class="button-group center">
      ...
      <button id="them" type="button" onclick="check('add')"
       ...
       <button id="them" type="button" onclick="check('close')"
  ...
  <div class="panel panel-default">
    ...
    <table class="table table-bordered">
      <thead>
        ...
        <th class="center">
          <fmt:message key="ttindthau.sua"/>
        </th>
        <th class="center">
          <fmt:message key="ttindthau.xoa"/>
        </th>
      </thead>
        ...
        <logic:notEmpty name="lstTTDT">
          <logic:iterate id="objTTDT" name="lstTTDT" >
            <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>'
              ...
              <td class="icon" >
              <logic:equal value="true" name="objTTDT" property="isAddmore">
                <logic:equal value="0" name="objTTDT" property="khoi_luong_them">
                <a href='<html:rewrite page="/AddMoreTTinDThauAction.do"/>?longid=<bean:write name="objTTDT" property="guid"/>'>
                  <span class="glyphicon glyphicon-plus" style="color:green"></span></a>
                  </logic:equal>
              </logic:equal>
              </td>
              <td class="icon">
                <logic:equal value="00" name="objTTDT" property="trang_thai">
                  <a href='<html:rewrite page="/UpdateTTinDThauAction.do"/>?longid=<bean:write name="objTTDT" property="guid"/>'>
                    <span class="glyphicon glyphicon-pencil success"></span></a>
                </logic:equal>
                <logic:equal value="03" name="objTTDT" property="trang_thai">
                  <a href='<html:rewrite page="/UpdateTTinDThauAction.do"/>?longid=<bean:write name="objTTDT" property="guid"/>'>
                    <span class="glyphicon glyphicon-pencil success"></span></a>
                </logic:equal>
                 &nbsp;
              ...
              <td class="icon">
                <logic:equal value="00" name="objTTDT" property="trang_thai">
                  <a href='<html:rewrite page="/DeleteTTinDThauAction.do"/>?longid=<bean:write name="objTTDT" property="guid"/>'
