...
<script type="text/javascript">
  ...
  function goPage(page) {
   ...
   function check(type) {
      ...
      f.target = '';
      if (type == 'add') {
          f.action = 'PreUploadKQPhatHanhTinPhieuAction.do';
          f.submit();
      }
      if (type == 'close') {
  ...
  function validateFloatKeyPress(el, evt) {
    ...
    function dbclick(guid){
       var f =document.forms[0];
         f.target='';
        if(guid!=null){
        f.action="ViewKQPHTinPhieuAction.do?longid="+guid;
        f.submit();
       }
     }
</script>
...
<html:form action="/SearchKQPhatHanhTinPhieuAction.do" method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <html:text styleClass="form-control" onfocus="textfocus(this);"
                           styleId="dot_dt" onblur="textlostfocus(this);" onkeyup="format(this)"
                           maxlength="10" onkeypress="return validateFloatKeyPress(this,event);"
                           tabindex="1" property="dot_ph"/>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <div class="input-group date">
                  ...
                  <label for="ngay_phat_hanh_den_ngay" class="input-group-addon"> 
                    <span class="glyphicon glyphicon-calendar"></span>
                     </label>
                </div>
              </div>
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <logic:notEmpty name="lstKQphathanh">
          <logic:iterate id="objKQphathanh" name="lstKQphathanh" >
            <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>'
                ondblclick="dbclick('<bean:write name="objKQphathanh" property="guid"/>')">
              ...
              <td class="icon">
                <logic:notEqual value="1" name="objKQphathanh" property="trang_thai">
                  <logic:notEqual value="2" name="objKQphathanh"
                                  property="trang_thai">
                    <a href='<html:rewrite page="/UpdateKQPhatHanhTinPhieuAction.do"/>?longid=<bean:write name="objKQphathanh" property="guid"/>'>
              ...
              <td class="icon">
                <logic:notEqual value="1" name="objKQphathanh" property="trang_thai">
                  <logic:notEqual value="2" name="objKQphathanh" property="trang_thai">
                    <a href='<html:rewrite page="/DeleteKQPhatHanhTinPhieuAction.do"/>?longid=<bean:write name="objKQphathanh" property="guid"/>'
