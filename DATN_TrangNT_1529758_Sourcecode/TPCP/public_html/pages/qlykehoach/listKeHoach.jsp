...
<script type="text/javascript">
  ...
  function check(type) {
      ...
      f.target = '';
      if (type == 'add') {
          f.action = 'QuanLyKeHoachAddAction.do';
          f.submit();
      }
      else if (type == 'close') {
   ...
   function view(id) {
      ...
      f.target = '';
      if(id != null && id != ""){
      f.action = 'QuanLyKeHoachViewAction.do?longid=' + id;
      f.submit();
      }
  }
  ...
  function ChangeReplace(ngay_het_han, guid) {
      ...
      if (confirm("Bạn có chắc chắn muốn thay thế kế hoạch không?") == true) {
          if (ngayhet_han < today) {
              ...
              f.action = 'QuanLyKeHoachChangeAction.do?longid=' + guid;
          }
      }
...
<html:form action="/SearchQuanLyKeHoachAction.do" method="post">
  ...
  <div class="panel panel-default">
    ...
    <table class="table table-bordered" id="mytable">
      ...
      <tbody>
        ...
        <logic:notEmpty name="lstKH">
          <logic:iterate id="objTPCP" name="lstKH" >
             ...
             <bean:write name="objTPCP" property="nam_ph"/>
              ...
              <td class="icon">
                <logic:equal value="03" name="objTPCP" property="trang_thai">
                  <a href='<html:rewrite page="/QuanLyKeHoachUpdateAction.do"/>?longid=<bean:write name="objTPCP" property="guid"/>'>
              ...
              <td class="icon">
                <logic:equal value="03" name="objTPCP" property="trang_thai">
                  <a href='<html:rewrite page="/QuanLyKeHoachDeleteYearAction.do"/>?longid=<bean:write name="objTPCP" property="guid"/>'
