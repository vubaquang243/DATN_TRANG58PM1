...
<script type="text/javascript">
  ...
  function check(type) {
      ...
      if (type == 'close') {
          ...
          f.action='SearchQuanLyKeHoachQuyPDAction.do';
          if (validateForm()) {
              f.submit();
          }
      }
    ...
    function view(id) {
      ...
      f.target = '';
      if(id != null && id != ""){
      f.action = 'QuanLyKeHoachQuyPDViewAction.do?longid=' + id;
      f.submit();
      }
  }
...
//      }
  ...
  $(function () {
      ...
      $("#tong_khoi_luong").keydown(function (event) {
          return onkeydownnodot(event);
      });
...
<html:form action="/ListQuanLyKeHoachQuyPDAction.do" method="post">
  <div class="panel-heading border-bottom">
    <h1 class="panel-title">
      <strong>
        <fmt:message key="qlykehoach.title.pheduyet"/></strong>
    </h1>
  </div>
  <div class="app_error">
  ...
  <div class="panel panel-default">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        <logic:notEmpty name="lstKHQuy">
          <logic:iterate id="objTPCP" name="lstKHQuy" >
            <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>' ondblclick="view('<bean:write name="objTPCP" property="guid"/>')">
              ...
              <td>
                ...
                <logic:equal name="objTPCP" property="thoi_gian_ph" value="4">Qu&yacute;
                                                                              IV</logic:equal>/<bean:write name="objTPCP" property="nam_ph"/>
              </td>
              <td class="right">
              ...
              <td class="icon">
                <logic:equal value="01" name="objTPCP" property="trang_thai">
                  <a href='<html:rewrite page="/QuanLyKeHoachQuyPDViewAction.do"/>?longid=<bean:write name="objTPCP" property="guid"/>'>
