...
<script>
  ...
  function validateForm() {
      ...
      if(parseInt(nam_ph)==0){
        alert("Bạn không được nhập năm phát hành :0000");
        $("#nam_ph").focus();
          return false;
      }
      ...
      if(toNumber(tong_klph)==0){
        alert('Bạn phải nhập tổng mức phát hành quý lớn hơn 0 !');
          $("#tong_klph").focus();
          return false;
      }
      ...
      var kh= document.getElementById("so_tbao_kh").value;
      if(  kh.trim() != ""){
      
      var kh_cu= '<bean:write name="QuanLyKeHoachQuyForm" property="so_tbao_kh_cu"/>';
      if(kh_cu == kh){
        alert('Bạn không được nhập số thông báo kế hoạch trùng với số thông báo kế hoạch cũ !');
        $("#so_tbao_kh").focus();
        return false;
        }
      }
      var kh_goc= '<bean:write name="QuanLyKeHoachQuyForm" property="kh_goc"/>';
      if(kh_goc!=""){
      ...
      if(!isDate(ngay_hieu_luc)){
        alert("Bạn nhập sai định dạng ngày hiệu lực ");
        $("#ngay_hieu_luc").focus();
        return false;
      }
      ...
      if(thoi_gian_ph ==1){
        ...
        if(ngay_tbao_time > endTime){
          alert('Bạn phải nhập ngày thông báo kế hoạch nhỏ hơn hoặc bằng ngày hết hiệu lực kế hoạch ');
          $("#ngay_tbao_kh").focus();
          return false;
        }
  ...
  function UpperCase(){
      var x = document.getElementById("so_tbao_kh");
  ...
  $(function () {
      ...
      var Loai_tien ='<bean:write name="QuanLyKeHoachQuyForm" property="loai_tien"/>';
      if(Loai_tien!=""){
        if(Loai_tien == 'VND'){
...
<html:form action="QuanLyKeHoachQuyAddAction" method="post">
  ...
  <logic:equal value="" name="QuanLyKeHoachQuyForm" property="guid">
    <h1 class="panel-title">
      <strong>
        <fmt:message key="qlykehoach.title"/></strong>
    </h1>
    </logic:equal>
     <logic:notEqual value="" name="QuanLyKeHoachQuyForm" property="guid">
     
    <h1 class="panel-title">
      <strong>
        <fmt:message key="qlykehoach.title.sua"/></strong>
    </h1>
    </logic:notEqual>
  </div>
    ...
    <div class="panel-body">
      <div class="form-horizontal">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                ...
                <html:select property="loai_tien" styleId="loai_tien"  onchange="changeTypeMonney()"
                             tabindex="4" styleClass="form-control selectpicker"
                             onkeydown="if(event.keyCode==13) event.keyCode=9;">
        ...
        <div class="row">
          ...
          <logic:notEqual value="" name="QuanLyKeHoachQuyForm" property="kh_goc">
             <div class="col-md-6">
            <div class="form-group">
              <label for="hoten" class="col-sm-4 control-label">
        ...
        <logic:notEmpty  name="QuanLyKeHoachQuyForm" property="ly_do_tu_choi">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="hoten" class="col-sm-4 control-label">
  ...
  <div class="panel panel-default">
    ...
    <table class="table table-bordered">
      <thead>
        ...
        <th>
          <div id="so_tien_vnd" ><fmt:message key="tpcp.so_tien_vnd"/></div>
          <div id="so_tien_usd" style="display:none;"><fmt:message key="tpcp.so_tien_usd"/></div>
        </th>
      </thead>
  ...
  <html:hidden name="QuanLyKeHoachQuyForm" property="kh_goc"/>
  <div class="center">
