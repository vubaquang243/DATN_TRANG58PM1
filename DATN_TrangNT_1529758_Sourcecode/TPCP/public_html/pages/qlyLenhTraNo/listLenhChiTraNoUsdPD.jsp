...
<script type="text/javascript">
  ...
  function check(type) {
      ...
      f.target = '';
      if (type == 'find') {
          f.action = 'SearchLenhTraNoUsdPDAction.do';
      }
      f.submit();
  }
  function view(id_lenh) {
      var f = document.forms[0];
      f.action = 'ViewLenhTraNoUsdPDAction.do?longid='+id_lenh;
      f.submit();
  }
  $(function () {
      $("#so_lenh").focus();
...
<html:form action="/ListLenhTraNoUsdPDAction.do" method="post">
  <div class="panel-heading border-bottom">
    <h1 class="panel-title">
      <strong>PHÊ duyệt thông tin lệnh chi trả nợ trong nước</strong>
    </h1>
  </div>
  <div class="app_error">
          ...
          <logic:iterate id="objTPCP" name="listLenhTriTraNo" indexId="stt">
            <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>' ondblclick="view('<bean:write name="objTPCP" property="guid"/>')">
              ...
              <td align="center">
                ...
                <td align="right">
                <bean:write name="objTPCP" property="tong_tien"/>
                </td>
                <td align="center">
              ...
              <td class="icon">
                <logic:notEqual value="02" name="objTPCP"
                                property="trang_thai">
                  <logic:notEqual value="03" name="objTPCP"
                                  property="trang_thai">
                    <a href='<html:rewrite page="/ViewLenhTraNoUsdPDAction.do"/>?longid=<bean:write name="objTPCP" property="guid"/>'>
