...
<script type="text/javascript">
  ...
  function check(type) {
     ...
     if(type=='saveandsub'){
     if(confirm("Bạn có muốn thêm mới và trình HD bán tín phiếu này không? ")){
        f.action='AddAndSubHDBanTinPhieuAction.do';
         if (validateForm()) {
    ...
    function parseString(str){
      ...
      if(!isNaN(parseInt(ms1,10)) &&  ms2!="HĐ"){
        return true;
      }
      return false;
    }
  ...
  $(function () {
     $("#lai_suat").keyup(function (event) {
      ...
      $("#ma_tp").focus();
       $("#ky_han").attr("data-live-search",true);     
      $("#ky_han").focus();
      $("#ngay_hd").datepicker( {
          dateFormat : "dd/mm/yy"
    ...
    function toUpperCase(){
      var x = document.getElementById("so_hd");
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <html:text styleClass="form-control"
                           ...
                           name="HDBanTinPhieuForm"
                           styleId="so_hd" property="so_hd" onkeyup="toUpperCase()" />
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <html:select property="ma_tp" styleId="ma_tp" name="HDBanTinPhieuForm"
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <div class="input-group date">
                  <html:text styleClass="form-control" styleId="ngay_hd" name="HDBanTinPhieuForm"
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <html:text styleClass="form-control" name="HDBanTinPhieuForm"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <html:text styleClass="form-control" name="HDBanTinPhieuForm"
                           ...
                           onkeydown="if(event.keyCode==13) event.keyCode=9;"
                           onfocus="textfocus(this);" onblur="ChangeLs(this)"
                            tabindex="5"
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-7">
                ...
                <html:select property="ky_han" styleId="ky_han"   onchange="ngay_dao_hanChange()"                        
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <html:text styleClass="form-control" styleId="gia_ban"
                           onfocus="textfocus(this);" name="HDBanTinPhieuForm"
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <div class="input-group date">
                  <html:text styleClass="form-control" styleId="ngay_ph" name="HDBanTinPhieuForm"
                             onkeydown="if(event.keyCode==13) event.keyCode=9;"
                             style="background-color: rgb(255, 255, 255); margin: 0px; width: 228px; height: 25px;"
                             tabindex="8" onfocus="textfocus(this);" onkeyup="doFormat(event)"
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <div class="input-group date">
                  <html:text styleClass="form-control" name="HDBanTinPhieuForm"
                             styleId="ngay_tt_tien_mua" onkeyup="doFormat(event)"
                             onkeydown="if(event.keyCode==13) event.keyCode=9;"
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <div class="input-group date">
                  <html:text styleClass="form-control" styleId="ngay_dao_han" name="HDBanTinPhieuForm"
                             onkeydown="if(event.keyCode==13) event.keyCode=9;"
                             style="background-color: rgb(255, 255, 255); margin: 0px; width: 228px; height: 25px;"
                             tabindex="10" onfocus="textfocus(this);" onkeyup="doFormat(event)"
                             onblur="textlostfocus(this);"
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-7" >
                <html:text styleClass="form-control" styleId="tt_dky_lky" name="HDBanTinPhieuForm"
                           onfocus="textfocus(this);"
                           style="background-color: rgb(255, 255, 255); margin: 0px; width: 735px; height: 44px;"
