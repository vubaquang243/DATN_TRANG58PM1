...
<fmt:setBundle basename="com.seatech.tp.resource.KTVTabmisResource"/>
             ...
             <%-- Hiển thị list KTV--%>
              <table  class="navigateable focused" cellspacing="0"
                      ...
                      <thead>
                        ...
                        <th  bgcolor="#f0f0f0" width="8%" align="center">
                        ...
                        <th  bgcolor="#f0f0f0" width="10%" align="center">
                          <label>Time sleeping</label>
                        </th>
                       
                        <th  bgcolor="#f0f0f0" align="center">
                          <label>M&#244; t&#7843;</label>
                        </th>
