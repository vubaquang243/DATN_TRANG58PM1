  ...
  function check(type) {
      ...
      if (type == 'pheduyet') {
          if (confirm('Bạn có muốn phê duyệt kết quả phát hành trái phiếu này không ?')){
            f.action = 'PheDuyetKQPhatHanhAction.do';
            f.submit();
          }
      }
      else if (type == 'tuchoi'){
          f.action = 'TuChoiKQPhatHanhAction.do';
          if (validateForm()) {
              f.submit();
          }
      }
      if (type == 'close') {
          f.action = 'ListKQphathanhPDAction.do';
          f.submit();
      }
  }
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-8">
              <div class="input-group date">
                <html:text styleClass="form-control" styleId="ngay_tb_de_nghi_ph"
                           tabindex="7" readonly="true"
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="col-sm-10">
              <logic:equal value="01" name="QLyKQPhatHanhForm" property="trang_thai">
              ...
              <logic:notEqual value="01" name="QLyKQPhatHanhForm" property="trang_thai">
                <html:textarea rows="2" styleClass="form-control" readonly="true" tabindex="5"
                               styleId="ly_do_tu_choi"
                               property="ly_do_tu_choi"/>
              </logic:notEqual>
              </div>
