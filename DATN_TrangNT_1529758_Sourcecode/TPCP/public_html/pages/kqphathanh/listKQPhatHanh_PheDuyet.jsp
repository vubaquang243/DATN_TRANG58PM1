...
<script type="text/javascript">
  ...
  function viewDetail(guid){
    ...
    f.target = '';
    if(guid!=null&&guid!=''){
      f.action = 'viewKQPhatHanhPDAction.do?longid='+guid;
      f.submit();
    }
  }
...
<html:form action="/SearchKQphathanhPDTwAction.do" method="post">
  <div class="panel-heading border-bottom">
    <h1 class="panel-title">
      <strong>
        <fmt:message key="kqphathanh.pheduyet.title"/></strong>
    </h1>
  </div>
  <div class="app_error">
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <html:text styleClass="form-control" onfocus="textfocus(this);"   
                           ...
                           maxlength="8" styleId="dot_dt"
                           onblur="textlostfocus(this);" tabindex="1" onkeyup="format(this)" 
                           property="dot_dt"/>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <html:text styleClass="form-control" onfocus="textfocus(this);"
                           maxlength="10" onblur="textlostfocus(this);upperCase(this);"
      ...
      <tbody>
        ...
        <logic:notEmpty name="lstKQphathanh">
          <logic:iterate id="objKQphathanh" name="lstKQphathanh" indexId="stt">
            <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>' ondblclick="viewDetail('<bean:write name="objKQphathanh" property="guid"/>');">
              <td class="center">
                <%=stt + 1%>
              </td>
              <td class="left">
              ...
              <td class="icon">
                <logic:notEqual value="2" name="objKQphathanh"
                                property="trang_thai">
                  <logic:notEqual value="3" name="objKQphathanh"
                                  property="trang_thai">
                    <a href='<html:rewrite page="/viewKQPhatHanhPDAction.do"/>?longid=<bean:write name="objKQphathanh" property="guid"/>'>
