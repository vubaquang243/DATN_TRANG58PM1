...
<script type="text/javascript">
  ...
  function check(type) {
      ...
      if (type == 'find') {
          f.action = 'SearchKQduthauPDAction.do';
          if (validateForm()) {
            f.submit();
          }
      }
  ...
  function viewChiTiet(guid){
    var f = document.forms[0];
      f.target = '';
      if (guid != null && guid != '') {
          f.action = 'ViewKetQuaDThauPDAction.do?longid=' + guid;
          f.submit();
      }
  }
...
<html:form action="/SearchKQduthauPDAction.do" method="post">
  <div class="panel-heading border-bottom">
    <h1 class="panel-title">
      <strong>Ph&ecirc; duyệt kết quả dự thầu TPCP</strong>
    </h1>
  </div>
  <div class="app_error">
  ...
  <div class="panel panel-default">
    ...
    <table class="table table-bordered">
      <thead>
        ...
        <th class="center">Ph&ecirc; duyệt</th>
      </thead>
      ...
      <tbody>
        <logic:empty name="listKQDT">
          <tr>
            <td colspan="12" align="center" class="color_red">Kh&ocirc;ng c&oacute;
                                                              dữ liệu</td>
          </tr>
        </logic:empty>
        <logic:notEmpty name="listKQDT">
          <logic:iterate id="objTTDT" name="listKQDT" indexId="stt">
            <tr class='<%=stt % 2 == 0 ? "trDanhSachChan" : "trDanhSachLe"%>' ondblclick="viewChiTiet('<bean:write name="objTTDT" property="guid"/>')">
              <td align="center">
                <%=stt + 1%>
              </td>
              <td>
              ...
              <!--Sửa-->
              <td class="icon">
                <logic:notEqual value="2" name="objTTDT" property="trang_thai">
                  <logic:notEqual value="3" name="objTTDT"
                                  property="trang_thai">
                    <a href='<html:rewrite page="/ViewKetQuaDThauPDAction.do"/>?longid=<bean:write name="objTTDT" property="guid"/>'>
